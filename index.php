    ...
    <body id="page">
        ...
        <ul class="cb-slideshow">
            <li>
            	<span>Image 01</span>
            		<div>
            			<h3><img src="css/splas.png" width="22%">  </h3>
            		</div>
            </li>
            <li><span>Image 02</span><div><h3>MEDITERRANO</h3></div></li>
            <li><span>Image 03</span><div><h3><img src="css/splas.png" width="22%"></h3></div></li>
            <li><span>Image 04</span><div><h3>MEDITERRANO</h3></div></li>
            <li><span>Image 05</span><div><h3><img src="css/splas.png" width="22%"></h3></div></li>
            <li><span>Image 06</span><div><h3>MEDITERRANO</h3></div></li>
        </ul>
        <div class="container">
            
            <header>
                <h1> <span>MEDITERRANO.<br> taste of the mediterranean</span></h1>
